...
import { ChevronLeft, ChevronRight, BarChart3, Clock, AlertCircle, TrendingUp, Award, Zap, Loader2 } from 'lucide-react'
  ...
  return (
    <div style={{ maxWidth:860, margin:'0 auto' }}>
      ...
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:22, flexWrap:'wrap', gap:12 }}>
        <div>
          <h2 style={{ margin:0, fontSize:20, fontWeight:800, color:'var(--text)' }}>Weekly Performance</h2>
          <p style={{ margin:'3px 0 0', fontSize:13, color:'var(--text-muted)' }}>Your productivity snapshot</p>
        </div>
        {/* Week nav */}
