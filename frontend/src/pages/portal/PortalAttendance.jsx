...
import {
  ...
  ChevronLeft, ChevronRight, CheckCircle2, XCircle, FileText, Send
} from 'lucide-react'
    ...
    <div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(130px,1fr))', gap:12, marginBottom:18 }}>
        {[
          ...
          { label:'Overtime',  value: `${(summary?.totalOT||0).toFixed(1)}h`,      icon: Clock,        bg:'#faf5ff', color:'#6b21a8' },
      ...
      {loading ? (
        ...
        <div className="pa-card">
          <div className="pa-table-head" style={{ gridTemplateColumns:'100px 80px 80px 70px 70px 90px' }}>
            {['Date','Punch In','Punch Out','Hours','OT','Status'].map(h => (
          ...
          <div style={{ maxHeight:440, overflowY:'auto' }}>
            {history.map((row, i) => (
              <motion.div key={i} initial={{ opacity:0 }} animate={{ opacity:1 }}
                className="pa-table-row" style={{ gridTemplateColumns:'100px 80px 80px 70px 70px 90px' }}>
